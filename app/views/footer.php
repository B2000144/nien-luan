          ...
          <div class="bg_in">
              <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                      ...
                      <div class="footer-col-content">
                          <ul class="social">
                              <li><a target="_blank" href="https://www.facebook.com/groups/925115961167823" class="fb"><img src="<?php echo BASE_URL ?>/public/images/Fb.png">Facebook</a>
                              </li>
                              <li><a target="_blank" href="https://www.youtube.com/channel/UCEsESsjOOUJQjnwJ5djnbNQ" class="fb"><img height="32" width="32" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                          </ul>
                          <div class="clear"></div>
                      </div>
                  </div>
