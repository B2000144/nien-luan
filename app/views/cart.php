                                  ...
                                  <form action="<?php echo BASE_URL ?>/giohang/updategiohang" method="POST">
                                      <?php
                                        ...
                                        ?>
                                          <tr class="tr">
                                              <td data-th="Hình ảnh">
                                                  <div class="col_table_image col_table_hidden-xs"><img src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $value['product_image'] ?>" alt="<?php echo $value['product_title'] ?>" class="img-responsive" />
                                                  </div>
                                              </td>
                                              <td data-th="Sản phẩm">
                                              ...
                                              <td data-th="Giá"><span class="color_red font_money"><?php echo number_format($value['product_price'], 0, ',', '.') . 'đ' ?></span>
                                              </td>
                                              ...
                                              <td data-th="Thành tiền" class="text_center"><span class="color_red font_money"><?php echo number_format($subtotal, 0, ',', '.') . 'đ' ?></span>
                                              </td>
                          ...
                          <div class="ch-contacts-details">
                              <ul class="contact-list">
                                  <li class="addr">
                                      ...
                                      <p><em><strong>ONLINE SHOP</strong></em><br />
                                      <p>Shop bán quần áo:</p>
                                      <p>CN1: Phường xuân khánh, TP Cần thơ</p>
                                      <p>CN2: Phường An lạc, TP Cần Thơ</p>
