                                ...
                                <div class="content">
                                    ...
                                    <div class="img-right-pro">
                                        ...
                                        <a
                                            ...
                                            <img class="lazy img-pro content-image pic"
                                    ...
                                    <div class="price_old_new">
                                        <div class="price">
                                            <span
                                                class="news_price"><?php echo number_format($product['price_product'], 0, ',', '.') . 'đ' ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grids_in">
                                <div class="content">
                                    ...
                                    <div class="price_old_new">
                                        <div class="price">
                                            <span
                                                class="news_price"><?php echo number_format($pro_cate['price_product'], 0, ',', '.') . 'đ' ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
